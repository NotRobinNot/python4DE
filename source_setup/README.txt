*Note: all detail in this txt file, as well as all of the files found in the source_setup folder, were generated using AI to simply create a starting point with dummy data in various environments that I could begin using for a basic pipeline project with python.*
